...
public class HutRenameMessage extends AbstractMessage<HutRenameMessage, IMessage>
{
     ...
     */
    public HutRenameMessage(@NotNull final Colony colony, final String name, final AbstractBuilding b)
    {
        super();
    ...
    public void messageOnServerThread(final HutRenameMessage message, final EntityPlayerMP player)
    {
        ...
        final AbstractBuilding b = colony.getBuildingManager().getBuildings().get(buildingId);
        if (colony != null)
        {
            ...
            b.setBuildingName(message.name);
